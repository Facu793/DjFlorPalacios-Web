        ...
        <footer>
          <div className="container" style={{textAlign:'center'}}>
            ...
            <div style={{marginTop:6, fontSize:'13px'}}>
              ...
              <a 
                href="https://wa.me/543496515213?text=Hola!%20Me%20interesa%20tu%20servicio%20de%20desarrollo" 
                target="_blank" 
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = 'var(--brand, #ff2da1)'
                  e.currentTarget.style.textDecoration = 'underline'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.color = 'var(--accent, #9b5cff)'
                  e.currentTarget.style.textDecoration = 'none'
                }}
              >
                {t[language].footer.powered}
